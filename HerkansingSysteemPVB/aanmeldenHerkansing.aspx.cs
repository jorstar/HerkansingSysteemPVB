...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void btnAanmelden_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Message.Body += "<html><head><style>*{padding:0;margin:0;font-family:Arial;}"
                + "#MainContent{width:80%;background-color: none;height: auto;margin: 50px auto;border: 2px #0072bc solid;}"
                + "#TopSpacer{height: 10px;}#Title{text-align: center;padding: 10px 0;font-size: 25px;font-weight: bold;background-color: #A8B326;}"
                + "#HerkansingInfo{border-top: 2px dashed #0072bc;padding: 50px 35px 15px 35px;}"
                + "#eMailLinkHerePlox{text-align: center;padding: 35px 0;font-style:oblique;}"
                + "#herkansingTitle{padding: 0 0 25px 35px;}</style></head>"
                + "<body><div id=\"TopSpacer\"></div><div id=\"MainContent\"><div id=\"Title\">Herkansing bevestigen</div>"
                + "<div id=\"HerkansingInfo\"><div id=\"herkansingTitle\">Herkansing informatie"
                ...
                + "<div id=\"eMailLinkHerePlox\">Bevestigings link: <a href=\"http://127.0.0.1:8085/login.aspx\" target=\"_blank\">http://127.0.0.1:8085/login.aspx</a></div></div></body></html>";
