...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void btnAanmelden_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            + "<div style=\"text-align: center;padding: 35px 0;font-style:oblique;\">Bevestigings link (Zo snel mogelijk: <a href=\"http://127.0.0.1:8085/mailbevestigen.aspx?herkansing=" + objGuid + "\" target=\"_blank\">http://127.0.0.1:8085/mailbevestigen.aspx?herkansing=" + objGuid + "</a></div></div></body></html>";
