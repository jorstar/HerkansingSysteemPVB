        ...
        <tr>
            <td>
                ...
                <table style="width: 600px; margin: 50px auto 50px auto" class="fancyTable">
                    <tr><td><br /></td></tr>
                    <tr>
                        <td>Vak naam<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Vak naam is een verplicht veld!" ControlToValidate="txtVakNaam" ForeColor="Red">*</asp:RequiredFieldValidator>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>Vak beschrijving<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Vak beschrijving is een verplicht veld!" ControlToValidate="txtVakBeschrijving" ForeColor="Red">*</asp:RequiredFieldValidator>
                        </td>
                        <td>
